...
jQuery(function ($) {
	...
	$(document).ready(function () {
		...
		$('body').on('click', '.compare-remove', function () {
			...
			$.ajax({
				url: 'index.php?option=com_sellacious&task=compare.removeAjax',
				type: 'POST',
				data: {p: code},
				cache: false,
				dataType: 'json',
		...
		$('.btn-compare').click(function () {
			...
			$.ajax({
				url: 'index.php?option=com_sellacious&task=compare.' + (checked ? 'addAjax' : 'removeAjax'),
				type: 'POST',
				data: {p: code},
				cache: false,
				dataType: 'json',
		...
		$.ajax({
			url: 'index.php?option=com_sellacious&task=compare.addAjax',
			type: 'POST',
			data: {p: ''},
			cache: false,
			dataType: 'json',

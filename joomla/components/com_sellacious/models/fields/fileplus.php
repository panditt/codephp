...
class JFormFieldFilePlus extends JFormFieldFile
{
	...
	protected function getInput()
	{
		...
		$displayData = array_merge(get_object_vars($this), array('fileinput' => parent::getInput()));

		$options = array('debug' => 0);
		$html    = JLayoutHelper::render('com_sellacious.formfield.fileplus', (object) $displayData, '', $options);

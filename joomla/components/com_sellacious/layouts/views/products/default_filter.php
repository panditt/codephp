	...
	<form method="post" action="<?php echo JUri::getInstance()->toString(array('path', 'query', 'fragment')); ?>">
		...
		<div class="filter-snap-in">
			...
			<ul class="unstyled">
				...
				{
					$link   = sprintf('index.php?option=com_sellacious&view=products&filter[category_id]=%s', $category->id);
		...
		// Extra checkbox emulation to allow deselect all others and still overwrite userState ?>

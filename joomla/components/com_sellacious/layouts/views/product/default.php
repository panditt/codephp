...
<div class="margin-center" style="max-width: 1180px;">
	...
	<div id="product-info" style="max-width: 870px;">
		<h1>
		...
		<?php
		if (in_array('product', (array) $this->helper->config->get('product_features_list'))):
		...
		<div>
			<?php
			if (in_array('product', (array) $this->helper->config->get('splcategory_badge_display')) && is_array($item->get('special_listings')))
			{
...
<div class="description-text"><?php echo $item->get('description') ?></div>
...
if ($in_box || $pkg_items)
{
	?><br/><h4>WHATS IN BOX</h4><?php

	if ($in_box)
	{
		?><div class="content-text"><?php echo $in_box ?></div><?php
	}

...
<?php if (!empty($items)): ?>
	<table class="order-items w100p">
					...
					<?php if ($oi->package_items): ?>
						...
						<ol class="package-items">
							...
							foreach ($oi->package_items as $pkg_item):
								...
								?>
								<li><a class="dark-link-off" href="<?php echo $url ?>"><?php echo $pk_title ?> (<?php echo $pk_sku ?>)</a>
								</li><?php
							endforeach;
							?>
						</ol>
		...
		<?php endforeach; ?>
		<tr>
			<th class="text-right" colspan="3">Total Shipping Amount:</th>

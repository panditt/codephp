			...
			foreach ($order->items as $oi)
			{
				...
				<tr>
					...
					<td class="text-center">
						...
						{
							/* ?><a class="btn btn-default btn-small disabled btn-return-order"><i
								class="fa fa-undo"></i> <?php echo JText::_('COM_SELLACIOUS_ORDER_PLACE_RETURN'); ?></a><br><?php */
						}
						...
						{
							/* ?><a class="btn btn-default btn-small disabled btn-exchange-order"><i
								class="fa fa-exchange"></i> <?php echo JText::_('COM_SELLACIOUS_ORDER_PLACE_EXCHANGE'); ?></a><?php */
						}
						?>
					</td>

...
$shipQuotes = (array) $cart->get('ship_quotes', array());
$cQid       = $cart->get('ship_quote_id');
			...
			?><div class="tab-pane" id="sf-tab_<?php echo $ruleId ?>"><?php
				...
				// Single object found in pivot
					...
					if ($quote->service === null):
						...
						echo "<input type=\"hidden\" name=\"shipment\" value=\"\" class=\"select-shipment auto-select\"/>";
						echo "<p>No rates available&hellip;</p><div class='clearfix'></div>";

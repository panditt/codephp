...
<div class="address-content">
	...
	<?php if ($address->company): ?>
		<span class="address_company"><?php echo $address->company ?></span><br/>
	<?php endif; ?>
	<?php if ($address->po_box): ?>
		<span class="address_po_box">PO #: <?php echo $address->po_box ?></span><br/>
	<?php endif; ?>
